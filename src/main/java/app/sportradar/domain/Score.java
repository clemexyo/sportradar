...
public record Score(int homeScore, int awayScore) {
  ...
  /**
   * This is the *only* way to create a Score so all validation happens here. Every Score creation
   * passes through this.
   */
  public Score {
  ...
  /**
   * Returns a new Score with home team score incremented by 1. Follows immutability pattern -
  ...
  /**
   * Returns a new Score with away team score incremented by 1. Follows immutability pattern -
   * returns new instance.
   */
  ...
  /**
   * Returns a new Score with home team score incremented by specified amount. Validation
   * automatically runs in the constructor.
   */
  ...
  /**
   * Returns a new Score with away team score incremented by specified amount. Validation
   * automatically runs in the constructor.
   */
  ...
  /**
   * Returns a new Score with home team score decremented by specified amount. Validation
   * automatically runs in the constructor.
   */
  ...
  /**
   * Returns a new Score with away team score decremented by specified amount. Validation
   * automatically runs in the constructor.
   */
